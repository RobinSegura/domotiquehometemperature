...
@ComponentScan(basePackages = { "serveur.mobile.metier",
                                "serveur.mobile.web"})
...
public class Config {
     ...
     *
     * L'annotation @EnableAutoConfiguration demande à Spring Boot de configurer l'application
     * Spring MVC. Il assure de manière transparente cette tâche de configuration
     ...
     * certaines conventions dans les dépendances, la configuration prosuite sera minimale.
     */
}
